...
<body>
<center><h2 style="color:maroon">Welcome To Doctor Dashboard!!!</h2></center>
<br>
<form method="post" >
...
<%
	...
	try
	{
		...
		rst=stmt.executeQuery("select * from patients where temp>98 and pulserate>100 and bloodpressure>120");
%>
<br>
<center>
